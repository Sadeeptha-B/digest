// Minimal inline SVG icons (stroke = currentColor) to avoid an icon dependency.
...
export const GripIcon = ({ className = 'h-4 w-4' }: P) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden>
...
export const BackIcon = ({ className = 'h-4 w-4' }: P) => (
